...
This repo is a maker-repository. It stores the parameters and the STL-files of parts made with *desi75*.
This repo uses the javascript packages [desi75-cli](https://www.npmjs.com/package/desi75-cli) and [desi75-uis](https://www.npmjs.com/package/desi75-uis) of the design-library [desi75](https://charlyoleg2.github.io/parame75/).
...
For working with the latest *desi75* version:
...
```bash
git clone https://github.com/charlyoleg2/maker_parame75
cd maker_parame75
npm install
npm run
npm run desi75-uis
...
References for the maker\_parame75
----------------------------------

ID | Reference           | Design             | Nb of instances
---|---------------------|--------------------|----------------
1  | pastePusher         |  pastePusher       | 1
